...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> ot-porfolio">
									...
									<div class="catItemBody-i">
										...
										<?php if ($item->params->get('userItemReadMore')): ?>
											<div class="userItemReadMore">
												<a class="k2ReadMore button read-more" href="<?php echo $item->link; ?>">
	...
	<?php if($this->params->get('userFeedIcon',1)): ?>
		<div class="k2FeedIcon">
			<a href="<?php echo $this->feed; ?>" title="<?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?>"> <span><?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?></span> </a>
		</div>
	<?php endif; ?>
</div>
<!-- End K2 User Layout --> 