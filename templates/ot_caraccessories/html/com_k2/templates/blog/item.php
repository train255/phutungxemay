...
//echo base64_decode($mlp);?>
			...
			<div class="itemToolbar">
				<ul>
					...
					<?php if($this->item->params->get('itemHits')): ?>
						<li>
							<span class="itemHits">
								<?php echo $this->item->hits; ?> <?php echo JText::_('TPL_OT_K2_VIEW'); ?>
							</span>
						</li>
					<?php endif; ?>
		...
		<?php if($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
			<div class="itemRelated">
				...
				<ul class="itemRelatedList">
					<?php foreach($this->relatedItems as $key=>$item): //var_dump($item->imageGeneric); ?>
						<li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
							...
							<?php if($this->item->params->get('itemRelatedIntrotext')): ?>
								<div class="itemRelIntrotext">
									...
									<?php if ($item->params->get('catItemIntroTextWordLimit')){
										echo (K2HelperUtilities::wordLimit($item->introtext, $item->params->get('catItemIntroTextWordLimit')));
									} else {
										echo $item->introtext;
									}?>
								</div>
	...
	<?php if($this->item->params->get('itemComments') && !JRequest::getInt('print') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)):?>
		...
		<div class="itemComments">
			...
			<?php if($this->item->numOfComments>0 && $this->item->params->get('itemComments') && !JRequest::getInt('print') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2'))): ?>
				<div class="gkDate">
					<div><?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?></div>
				</div>
