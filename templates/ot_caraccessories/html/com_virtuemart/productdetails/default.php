...
$document->addScript('templates/ot_caraccessories/html/com_virtuemart/simple_thumbs.js');
$document->addScript('templates/ot_caraccessories/scripts/jquery.carousel.min.js');
//$document->addScript('templates/ot_caraccessories/scripts/jquery.imageLens.js');
?>
<script type="text/javascript">
	//jQuery(document).ready(function($) {
		//$('#large_images li a img').imageLens();
	//});
</script>
<script type="text/javascript">
var $jc = jQuery.noConflict();
$jc(function(){
	$jc("div.additional-images-i").carousel({ 
...
$j(function(){
	...
	$j(".product-related-products .product").css('width', Math.floor($itemwidth/2) + 'px');
