...
<div id="shoutbox">
	...
	<form id="chatForm" name="chatForm" method="post" action="index.php">
		<p>
			...
			<label id="lblName"><?php echo JText::_( 'NAME'); ?> <em><?php echo $name; ?></em></label>
			...
			<label id="lblName" for="shoutboxname"><?php echo JText::_( 'NAME'); ?></label>
			...
			<label id="lblText" for="chatbarText"><?php echo JText::_( 'MESSAGE'); ?></label>
